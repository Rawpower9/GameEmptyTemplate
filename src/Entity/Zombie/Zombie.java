...
//            System.out.println(bullets.get(i).getPosition().getXPixel() - this.getPosition().getXPixel());
            if (Math.sqrt(Math.pow(bullets.get(i).getPosition().getXPixel() - this.getPosition().getXPixel(),2)+Math.pow(bullets.get(i).getPosition().getYPixel() - this.getPosition().getYPixel(),2)) <= this.radius/2) {
